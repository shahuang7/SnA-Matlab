...
%%%%%%%%%%%%%%%%%%%%%%%%%
  set(job{nn},'FileDependencies',{'add_log_entry.m',...
                                  'calc_sqDist_blocks_with_masks_no_norm.m',...
                                  'dmat_with_masks_no_norm.m',...
                                  'get_row_col_range.m',...
                                  'read_dSq.m',...
                                  'remove_files.m',...
                                  'shift_and_add_squared_distances.m',...
                                  'SnA_with_masks_no_norm.m',...
  ...
  createTask(job{nn},@SnA_with_masks_no_norm,1,{param,numTasks,nn-1});
%%%%%%%%%%%%%%%%%%%%%%%
% user section #2 END %
%%%%%%%%%%%%%%%%%%%%%%%
  submit(job{nn});
