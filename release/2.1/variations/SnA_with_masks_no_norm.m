function status=SnA_with_masks_no_norm(param,numWorker,workerID)
%
% status=SnA_with_masks_no_norm(param,numWorker,workerID)
%
% performs shift-and-add_with_masks_no_norm
%
...
%%%%%%%%%%
% shift-and-add_with_masks_no_norm
%%%%%%%%%%
...
% boltzmann requires an extra step to set file permission
  fileName_wildcard = [param.fileName_prefix(length(param.fileName_directory)+2:end) ...
...
% end function SnA_with_masks_no_norm
