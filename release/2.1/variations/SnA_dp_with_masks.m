function status=SnA_dp_with_masks(param,numWorker,workerID)
%
% status=SnA_dp_with_masks(param,numWorker,workerID)
%
% performs shift-and-add_dp_with_masks
%
...
% end function SnA_dp_with_masks
